                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            TextButton(onPressed: (){Get.off(SignUpPage());}, child: Text("Sign Up",style: TextStyle(color: widgetColor),))
                          ],
                        ),
                        Row(
                          mainAxisSize: MainAxisSize.min,
                          ...
                          child: ElevatedButton(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text("Sign in with Gmail",style: TextStyle(color: Colors.white70,fontWeight: FontWeight.w400,fontSize: 17,),)
                              ],
                            ),
                          ),
                        )
